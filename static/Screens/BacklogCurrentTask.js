...
import BacklogGetTaskButton from "../components/BacklogGetTaskButton";

export function BacklogCurrentTask({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <BacklogGetTaskButton taskId={navigation.getParam('id')}/>
        </View>
    );
}
